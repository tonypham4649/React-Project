  ...
  return (
    <section className="vs-hero-wrapper hero-layout4 ">
      ...
      >
        <div
          className="ls-slide"
          data-ls="duration: 8000; transition2d: 5; kenburnszoom:out; kenburnsscale:1.1;"
        >
          <img
        ...
        <div
          className="ls-slide"
          data-ls="duration: 8000; transition2d: 5; kenburnszoom:in; kenburnsscale:1.1;"
        >
          <img
            src="/src/assets/img/hero/hero-bg-3-2.jpg"
            alt="Hero Image"
            className="ls-bg"
          />
          <p
        ...
        >
          <img
            src="/src/assets/img/hero/hero-bg-3-3.jpg"
            alt="Hero Image"
            className="ls-bg"
          />
          <p

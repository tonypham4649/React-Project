                    ...
                    <div className="vs-product-box1 thumb_swap">
                      ...
                      <div className="product-img">
                        <a href="shop-details.html">
                          <img
                            src="/src/assets/img/shop/product-1-1.png"
                            alt="Product Image"
                            className="w-100"
                          />
                        </a>
                        <a href="shop-details.html">
                          <img
                            src="/src/assets/img/shop/product-1-8.png"
                            alt="Product Image"
                  ...
                  <div className="col-sm-6 col-xl-4">
                    <div className="vs-product-box1 thumb_swap">
                      ...
                      <div className="product-img">
                        <a href="shop-details.html">
                          <img
                            src="/src/assets/img/shop/product-1-2.png"
                            alt="Product Image"
                            className="w-100"
                          />
                        </a>
                        <a href="shop-details.html">
                          <img
                            src="/src/assets/img/shop/product-1-7.png"
                            alt="Product Image"
                            className="w-100 img_swap"
                          />
                        </a>
                  ...
                  <div className="col-sm-6 col-xl-4">
                    <div className="vs-product-box1 thumb_swap">
                      <div className="product-img">
                        <a href="shop-details.html">
                          <img
                            src="/src/assets/img/shop/product-1-3.png"
                            alt="Product Image"
                            className="w-100"
                          />
                        </a>
                        <a href="shop-details.html">
                          <img
                            src="/src/assets/img/shop/product-1-6.png"
                            alt="Product Image"
                            className="w-100 img_swap"
                          />
                        </a>
                  ...
                  <div className="col-sm-6 col-xl-4">
                    <div className="vs-product-box1 thumb_swap">
                      ...
                      <div className="product-img">
                        <a href="shop-details.html">
                          <img
                            src="/src/assets/img/shop/product-1-4.png"
                            alt="Product Image"
                            className="w-100"
                          />
                        </a>
                        <a href="shop-details.html">
                          <img
                            src="/src/assets/img/shop/product-1-5.png"
                            alt="Product Image"
                            className="w-100 img_swap"
                          />
                        </a>
                  ...
                  <div className="col-sm-6 col-xl-4">
                    <div className="vs-product-box1 thumb_swap">
                      ...
                      <div className="product-img">
                        <a href="shop-details.html">
                          <img
                            src="/src/assets/img/shop/product-1-9.png"
                            alt="Product Image"
                            className="w-100"
                          />
                        </a>
